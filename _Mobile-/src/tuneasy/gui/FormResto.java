...
public class FormResto extends Form{
    ...
    public FormResto(Form previous) {
       ...
       new RechercheCapsule(previous, tfPrenom.getText().toString()).show();
       getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e -> previous.showBack());
       });
    ...
    public Container addRestaurantItem(Restaurant restaurant){
       ...
       Image img = URLImage.createToStorage(enc, "restaurant_"+restaurant.getNom(), "file:/C:/Users/oussa/Desktop/integrationWeb/public/upload/img"+restaurant.getPhoto(), URLImage.RESIZE_SCALE);
